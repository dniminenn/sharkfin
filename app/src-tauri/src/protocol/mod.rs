...
/// Driveall HID: AJAZZ / AULA online driver. Output reports, magic `AA`/`55`,
/// no checksum. Collection usage page `0xFF68` or `0xFF67`, usage `0x61`.
/// Opcodes and payload shapes from the host JS; write cmds 16-24 / 33-40
/// also sit in the SN34F280 HE image dispatcher. docs/PROTOCOL-DRIVEALL.md.
pub mod driveall;
